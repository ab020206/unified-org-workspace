      ...
      <div className="max-w-7xl mx-auto px-6 space-y-12">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-xs md:text-sm text-text-secondary">
            A step-by-step walk-through of the end-to-end user lifecycle inside Unified Organization
            Workspace.
          </p>
        </div>

        {/* Horizontal Stepper Selector */}
        <div className="flex items-center justify-between overflow-x-auto pb-4 border-b border-border no-scrollbar gap-2">
          {steps.map((step, idx) => {
        ...
        <motion.div
          ...
          className="p-6 rounded-[10px] border border-border bg-surface grid grid-cols-1 lg:grid-cols-12 gap-8 items-center shadow-xs"
        >
          <div className="lg:col-span-7 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="px-2.5 py-0.5 rounded text-[11px] font-mono font-medium bg-surface-secondary text-text-primary border border-border">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs font-mono text-success">
              <CheckCircle2 className="w-4 h-4 text-success" />
              <span>Automated Tenant Validation Active</span>
            </div>
          </div>

          <div className="lg:col-span-5 p-5 rounded-md border border-border bg-surface-secondary/50 font-mono text-xs space-y-3">
            ...
            <div className="space-y-1.5 text-[11px]">
              <p className="text-text-primary">
                ...
                {steps[activeStep].title.toUpperCase().replace(/\s+/g, '_')}
              </p>
              <p className="text-text-primary">
                <span className="text-text-secondary">&gt; tenant:</span> org_acme_enterprise
              </p>
              <p className="text-text-primary">
                <span className="text-success">&gt; status:</span> 200 OK (latency: 14ms)
              </p>
            </div>
          </div>
        </motion.div>
